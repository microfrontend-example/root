System.register(["single-spa"], function (e, t) {
  var n = {};
  return (
          ...
          (() => {
            ...
            return (
              ...
              (() => {
                ...
                function p(e, n) {
                  if ("object" !== t(n) || Array.isArray(n) || null === n)
                    throw Error(
                      "Invalid "
                        .concat(e, ": received ")
                        .concat(
                          Array.isArray(n) ? "array" : n,
                ...
                function d(e, n) {
                  if ("boolean" != typeof n)
                    throw Error(
                      "Invalid "
                        .concat(e, ": received ")
                        .concat(t(n), ", but expected a boolean")
                    );
                }
                function f(e, t, n, r) {
                  if (!r) {
                ...
                function m(e, t) {
                  if ((h(e, t), t.indexOf("/") < 0))
                    throw Error(
                      "Invalid "
                        .concat(e, ": received '")
                        .concat(
                          t,
                          "', but expected an absolute path that starts with /"
                        )
                    );
                }
                function v(e, n, r) {
                  if (
                    !Array.isArray(n) &&
                    ("object" !== t(t(n)) || "number" !== n.length)
                  )
                    throw Error(
                      "Invalid "
                        .concat(e, ": received '")
                        .concat(n, "', but expected an array")
                    );
                  for (
                  ...
                  for (var c = 0; c < n.length; c++)
                    r.apply(
                      void 0,
                      [n[c], "".concat(e, "[").concat(c, "]")].concat(a)
                    );
                }
                function y(e, t) {
                  var n;
                ...
                var b = Object.prototype.hasOwnProperty.call(e, "default")
                    ? Object.getOwnPropertyDescriptor(e, "default").value
                        .pathToActiveWhen
                    : e.pathToActiveWhen,
                  w = "undefined" != typeof Symbol ? Symbol() : "@";
                function E(e, t) {
                  if (l) return e.getAttribute(t);
                  var n = g(e.attrs, function (e) {
                ...
                function O(e, t, n) {
                  if ("application" === e.nodeName.toLowerCase()) {
                    ...
                    var r = { type: "application", name: E(e, "name") },
                      o = E(e, "loader");
                    if (o)
                      if (t.loaders && t.loaders.hasOwnProperty(o))
                        r.loader = t.loaders[o];
                      else if (l)
                        throw Error(
                    ...
                    var a = E(e, "error");
                    if (a)
                      if (t.errors && t.errors.hasOwnProperty(a))
                        r.error = t.errors[a];
                      else if (l)
                        throw Error(
                  ...
                  if ("redirect" === e.nodeName.toLowerCase())
                    return (
                      (n.redirects[y("/", E(e, "from"))] = y("/", E(e, "to"))),
                      []
                    );
                  if ("undefined" != typeof Node && e instanceof Node) {
                    ...
                    if (e.childNodes && e.childNodes.length > 0) {
                      ...
                      for (var d = 0; d < e.childNodes.length; d++) {
                        var f;
                        (f = e.routes).push.apply(
                          f,
                          c(O(e.childNodes[d], t, n))
                        );
                      }
                    }
                    return [e];
                  ...
                  if (e.childNodes) {
                    for (
                      ...
                      var v;
                      (v = h.routes).push.apply(v, c(O(e.childNodes[m], t, n)));
                    }
                    return [h];
                  }
                    ...
                    n.forEach(function (e, n) {
                      if ("application" === e.type) {
                        ...
                        o = j({
                          ...
                          parentContainer: r,
                          previousSibling: o,
                          shouldMount: a && e.activeWhen(t),
                          applicationContainers: i,
                        });
                ...
                function A(e) {
                  for (
                    ...
                    var a = r[o];
                    if ("application" === a.type) {
                      if (a.name === t) return a;
                    } else if ("route" === a.type) {
                      if (a.activeWhen(n)) {
                        var i = A({
                          applicationName: t,
                          location: n,
                ...
                function I(t) {
                  var n = [],
                    r = (0, e.checkActivityFunctions)(t ? T(t) : location);
                  return (
                    (0, e.getAppNames)().forEach(function (e) {
                ...
                var D,
                  ...
                  _ = (function (e, t) {
                    if ((e && e.nodeName) || "string" == typeof e) {
                      ...
                      e = (function (e) {
                        ...
                        l && e.isConnected && e.parentNode.removeChild(e);
                        var n = { routes: [], redirects: {} };
                        E(e, "mode") && (n.mode = E(e, "mode")),
                          E(e, "base") && (n.base = E(e, "base")),
                          E(e, "containerEl") &&
                            (n.containerEl = E(e, "containerEl"));
                        for (var r = 0; r < e.childNodes.length; r++) {
                          var o;
                          (o = n.routes).push.apply(
                            o,
                            c(O(e.childNodes[r], t, n))
                          );
                        }
                        return n;
                      })(e, t);
                    ...
                    return (
                      (function (e) {
                        ...
                        if (
                          ...
                          for (var r in (p(
                            "routesConfig.redirects",
                            e.redirects
                          ),
                          e.redirects)) {
                            var o = e.redirects[r];
                            m("routesConfig.redirects key", r),
                              m("routesConfig.redirects['".concat(r, "']"), o);
                          }
                        var a = l ? window.location.pathname : "/",
                          i = "hash" === e.mode ? a + "#" : "";
                        v(
                          "routesConfig.routes",
                          e.routes,
                          function e(t, r, o) {
                            var a = o.parentPath,
                              i = o.siblingActiveWhens,
                              c = o.parentActiveWhen;
                            if ((p(r, t), "application" === t.type))
                              f(
                                r,
                                t,
                                ...
                                t.props && p("".concat(r, ".props"), t.props),
                                h("".concat(r, ".name"), t.name);
                    ...
                    (function e(t, n, r, o) {
                      o.forEach(function (o) {
                        "application" === o.type
                          ...
                          : "route" === o.type
                          ? e(t, o.activeWhen, M(r, o.props), o.routes)
                  ...
                  U = (function (n) {
                    ...
                    if (!r)
                      throw Error(
                        "single-spa-layout constructLayoutEngine(opts): opts.routes must be provided. Value was ".concat(
                          t(r)
                        )
                      );
                    ...
                    function p(t) {
                      ...
                      if (n && n.error) {
                        var o = document.getElementById(C(n.name)),
                          a = "string" == typeof n.error ? P(n.error) : n.error;
                        c[n.name] = (0, e.mountRootParcel)(a, {
                          domElement: o,
                        });
                      }
                      setTimeout(function () {
                    ...
                    function d(n) {
                      ...
                      I(i).forEach(function (e) {
                        c[e] && (d.push(c[e].unmount()), delete c[e]);
                      }),
                        d.length > 0 &&
                          (a(),
                      ...
                      if (0 === W(r).indexOf(u)) {
                        var t =
                            "string" == typeof r.containerEl
                              ...
                              : r.containerEl,
                          n = (0, e.getMountedApps)().reduce(function (e, t) {
                            return (e[t] = document.getElementById(C(t))), e;
                          }, {});
                        j({
                          location: window.location,
                          routes: r.routes,
                    ...
                    function h(e) {
                      I(e.detail.newUrl).forEach(function (e) {
                        var t = document.getElementById(C(e));
                        t && t.isConnected && t.parentNode.removeChild(t);
                      });
                    }
                  })({ routes: _, applications: B });
                B.forEach(e.registerApplication), U.activate(), (0, e.start)();
              })(),
              a
            );
          })()
...
//# sourceMappingURL=throwjs-root-config.js.map
